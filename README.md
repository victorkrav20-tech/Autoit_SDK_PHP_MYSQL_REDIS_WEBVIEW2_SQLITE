# AutoIt SDK v0.4 - Модульная экосистема для разработки, подходит как для примеров для ai каждый модуль и работающие функции так и для полной разработки новых приложений. Ai Ready версия для всех ИИ.
