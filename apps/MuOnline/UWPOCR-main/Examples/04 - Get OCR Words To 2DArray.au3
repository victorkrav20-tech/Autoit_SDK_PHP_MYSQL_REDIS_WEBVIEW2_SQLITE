...
;~ 	_UWPOCR_Log(__UWPOCR_Log)
	...
	Local $sText = "Hello World!!!" & @CRLF & "AutoIt R2cks" & @CRLF & "0123456789" & @CRLF & "WPUOCR UDF"
	Local Const $iW = 250, $iH = 250
	...
	_GDIPlus_GraphicsDrawString($hBmpCtxt, $sText, 0, 0, "Arial", 11)  ;draw some text to the bitmap
