# AutoIt SDK v0.3 - Модульная экосистема для разработки
...
### 🎯 Текущий фокус:
- ✅ MCP сервер SDK CodeMapper v1.1.0 (поиск функций, редактирование кода, поддержка libs + apps)
- ✅ MySQL v2.0 (SQLite очереди + UUID v7 + SCADA функции)
- WebView2 динамические модули (в разработке, обсуждение деталей)

### 💻 Характеристики разработческого компьютера:
- **CPU:** AMD Ryzen 9600X
- **RAM:** 32GB DDR5 6000MHz
- **Storage:** NVMe SSD 7000MB/s (Kingston)
- **GPU:** AMD Radeon RX 580 (слабая, для ML не подходит)
- **Примечание:** Достаточно мощности для локальных ML моделей на CPU
